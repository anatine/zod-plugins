...
export const AttributeInputSchema = z.lazy(() =>
  z.object({
...
export const ComponentInputSchema = z.lazy(() =>
  z.object({
...
export const DropDownComponentInputSchema = z.lazy(() =>
  z.object({
...
export const EventArgumentInputSchema = z.lazy(() =>
  z.object({
    name: z.string(),
    value: z.string(),
  })
...
export const EventInputSchema = z.lazy(() =>
  z.object({
...
export const HTTPInputSchema = z.lazy(() =>
  z.object({
...
export const LayoutInputSchema = z.lazy(() =>
  z.object({
    dropdown: DropDownComponentInputSchema.nullish(),
  })
);

export const PageInputSchema = z.lazy(() =>
  z.object({
...
export const RegisterAddressInputSchema = z.lazy(() =>
  z.object({
    city: z.string(),
...
export const TestExampleSchema = z.lazy(() =>
  z.object({
...
export const TestInputSchema = z.lazy(() =>
  z.object({
